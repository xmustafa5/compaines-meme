...
export default function Company({ company, locale = "ar" }: { company: CompanyType, locale: "en" | "ar" }) {
    console.log(company)
    return (
        <Link href={`/${locale}/${company.geoid}`} className="overflow-hidden flex relative max-w-full w-full h-[256px] p-4 flex-col justify-end items-end gap-2 flex-shrink-0 rounded-[16px]">
